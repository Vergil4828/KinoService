...
class LoginUserData:
    ...
    test_data_valid_email = [
        ("user.name@example.com", 200, "valid_dot_in_local"),
        ("user+tag@example.com", 200, "valid_plus_in_local"),
        ("user-name@example.com", 200, "valid_dash_in_local"),
        ("user_name@example.com", 200, "valid_underscore_in_local"),
        ("user123@example.com", 200, "valid_numbers_in_local"),
        ("test@domain-name.com", 200, "valid_dash_in_domain"),
        ("user@sub.domain.com", 200, "valid_subdomain"),
        ("a" * 64 + "@example.com", 200, "maximum_local_part_length"),
        ("user@" + "a" * 63 + ".com", 200, "maximum_domain_length"),
    ]
