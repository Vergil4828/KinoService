...
async def admin_refresh_token_route(request_data: RefreshTokenRequest, request: Request):
    """
...
@router.get("/check", dependencies=[Depends(get_admin_user)], summary="Проверка аутентификации администратора")
